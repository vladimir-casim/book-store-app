          ...
          <div class="product col-sm-6 col-md-4 col-lg-3">
            <div class="thumbnail well">
              ...
              <div class="caption">
                ...
                <a href="<spring:url value="/books/admin/${book.id}/delete"/>" class="btn btn-danger" role="button">Delete</a>
                <a href="<spring:url value="/books/admin/${book.id}/update"/>" class="btn btn-warning" role="button">Update</a>
          ...
          <ul class="pagination">
            <c:forEach begin="${1}" end="${pagesCount}" var="p">
              <li class="${p == currentPage ? 'active' : 'none'}">
                <a href="<c:url value="/books/admin"><c:param name="page"  value="${p}" /></c:url>">${p}</a>
              </li>
            </c:forEach>
          </ul>
        </div>
