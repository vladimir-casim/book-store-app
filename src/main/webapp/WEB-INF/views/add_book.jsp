...
<div id="wrapper" class="container">
  <div id="category" class="row">
    <div id="featured" class="col-md-9">
      ...
      <spring:url value="/books/admin/save" var="formUrl"/>
      <form class="form-horizontal" action="${formUrl}" method="POST" enctype="multipart/form-data">
        <fieldset>
          ...
          <spring:bind path="book.imageFile">
            <div class="form-group ${status.error ? 'has-error' : ''}">
              <label class="col-md-2 control-label">Image</label>
              <div class="col-md-6">
                <input type="file" class="form-control" name="imageFile" title="Search for an image to add">
                <form:errors path="book.imageFile" cssClass="text-danger" />
              </div>
            </div>
          </spring:bind>

          <spring:bind path="book.bookFilePath">
            <div class="form-group ${status.error ? 'has-error' : ''}">
              <label class="col-md-2 control-label">File</label>
              <div class="col-md-6">
                <input type="file" class="form-control" name="bookFile" title="Search for a book to add">
